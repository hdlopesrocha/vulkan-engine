...
public:
    ...
    void loadScene(Octree &opaqueLayer, const OctreeChangeHandler& opaqueHandler,Octree &transparentLayer,const OctreeChangeHandler& transparentHandler) {
...

        {
            ...
            opaqueLayer.apply(SDF::opUnion, &function, model, translate, scale, LandBrush(), minSize, simplifier, opaqueHandler);
        }
        {
            ...
            opaqueLayer.apply(SDF::opUnion, &function, model, translate, scale, SimpleBrush(0), minSize, simplifier, opaqueHandler);
        }

        {
            ...
            opaqueLayer.apply(SDF::opUnion, &function, model, translate, scale, SimpleBrush(5), minSize, simplifier, opaqueHandler);
        }

        {
            ...
            Transformation model = Transformation(glm::vec3(sphere.radius), sphere.center, 0, 0, 0);
            SphereDistanceFunction function = SphereDistanceFunction(model, minSize);
            opaqueLayer.apply(SDF::opSubtraction, &function, model, translate, scale, SimpleBrush(20), minSize, simplifier, opaqueHandler);
        }

        {
            ...
            Transformation model = Transformation(glm::vec3(sphere.radius), sphere.center, 0, 0, 0);
            SphereDistanceFunction function = SphereDistanceFunction(model, minSize);
            opaqueLayer.apply(SDF::opSubtraction, &function, model, translate, scale, SimpleBrush(4), minSize, simplifier, opaqueHandler);
        }
...

        {
            ...
            Transformation model = Transformation(glm::vec3(sphere.radius), sphere.center, 0, 0, 0);
            SphereDistanceFunction function = SphereDistanceFunction(model, minSize);
            transparentLayer.apply(SDF::opUnion, &function, model, translate, scale, SimpleBrush(1), minSize, simplifier, transparentHandler);
        }

        {
            ...
            Transformation model = Transformation(glm::vec3(sphere.radius), sphere.center, 0, 0, 0);
            SphereDistanceFunction function = SphereDistanceFunction(model, minSize);
            transparentLayer.apply(SDF::opUnion, &function, model, translate, scale, SimpleBrush(2), minSize, simplifier, transparentHandler);
        }

        {
            ...
            opaqueLayer.apply(SDF::opUnion, &function, model, translate, scale, SimpleBrush(7), minSize, simplifier, opaqueHandler);
        }
    ...
    
        {
            ...
            opaqueLayer.apply(SDF::opUnion, &function, model, translate, scale, SimpleBrush(11), minSize, simplifier, opaqueHandler);
        }
...

        {
            ...
            Transformation model = Transformation(box.getLength()*0.5f, box.getCenter(), 0, 0, 0);
            BoxDistanceFunction function = BoxDistanceFunction(model, minSize);
            opaqueLayer.apply(SDF::opUnion, &function, model, translate, scale, SimpleBrush(6), minSize*0.5f, simplifier, opaqueHandler);
        }
    ...
    
        {
            ...
            transparentLayer.apply(SDF::opUnion, &function, model, translate, scale, WaterBrush(0), minSize, simplifier, transparentHandler);
        }
    
        {
            ...
            Transformation model = Transformation(box.getLength()*0.5f, box.getCenter(), 0, 0, 0);
            BoxDistanceFunction function = BoxDistanceFunction(model, minSize);
            opaqueLayer.apply(SDF::opUnion, &function, model, translate, scale, SimpleBrush(0), minSize*4, simplifier, opaqueHandler);
        }
        
        {
            ...
            Transformation model = Transformation(box.getLength()*0.5f, box.getCenter(), 0, 0, 0);
            BoxDistanceFunction function = BoxDistanceFunction(model, minSize);
            opaqueLayer.apply(SDF::opUnion, &function, model, translate, scale, SimpleBrush(0), minSize*0.25, simplifier, opaqueHandler);
        }
        
        {
            ...
            Transformation model = Transformation(box.getLength()*0.5f, box.getCenter(), 0, 0, 0);
            BoxDistanceFunction function = BoxDistanceFunction(model, minSize);
            opaqueLayer.apply(SDF::opPaint, &function, model, translate, scale, SimpleBrush(1), minSize*4.0, simplifier, opaqueHandler);
        }
        
        {
            ...
            Transformation model = Transformation(box.getLength()*0.5f, box.getCenter(), 0, 0, 0);
            BoxDistanceFunction function = BoxDistanceFunction(model, minSize);
            opaqueLayer.apply(SDF::opPaint, &function, model, translate, scale, SimpleBrush(1), minSize*0.25, simplifier, opaqueHandler);
        }
