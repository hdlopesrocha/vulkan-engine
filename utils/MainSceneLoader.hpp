...
public:
    ...
    void loadScene(Octree &opaqueLayer, const OctreeChangeHandler& opaqueHandler,Octree &transparentLayer,const OctreeChangeHandler& transparentHandler) {
...

        {
            ...
            opaqueLayer.apply(SDF::opUnion, &function, model, LandBrush(), minSize, simplifier, opaqueHandler);
        }
        {
            ...
            opaqueLayer.apply(SDF::opUnion, &function, model, SimpleBrush(0), minSize, simplifier, opaqueHandler);
        }

        {
            ...
            opaqueLayer.apply(SDF::opUnion, &function, model, SimpleBrush(5), minSize, simplifier, opaqueHandler);
        }

        {
            ...
            Transformation model = Transformation(glm::vec3(sphere.radius), sphere.center, 0, 0, 0);
            SphereDistanceFunction function = SphereDistanceFunction(model, minSize);
            opaqueLayer.apply(SDF::opSubtraction, &function, model, SimpleBrush(20), minSize, simplifier, opaqueHandler);
        }

        {
            ...
            Transformation model = Transformation(glm::vec3(sphere.radius), sphere.center, 0, 0, 0);
            SphereDistanceFunction function = SphereDistanceFunction(model, minSize);
            opaqueLayer.apply(SDF::opSubtraction, &function, model, SimpleBrush(4), minSize, simplifier, opaqueHandler);
        }
        
        {
            ...
            opaqueLayer.apply(SDF::opSubtraction, &distortedFunction, model, SimpleBrush(7), minSize, simplifier, opaqueHandler);
        }

        {
            ...
            Transformation model = Transformation(glm::vec3(sphere.radius), sphere.center, 0, 0, 0);
            SphereDistanceFunction function = SphereDistanceFunction(model, minSize);
            transparentLayer.apply(SDF::opUnion, &function, model, SimpleBrush(1), minSize, simplifier, transparentHandler);
        }

        {
            ...
            Transformation model = Transformation(glm::vec3(sphere.radius), sphere.center, 0, 0, 0);
            SphereDistanceFunction function = SphereDistanceFunction(model, minSize);
            transparentLayer.apply(SDF::opUnion, &function, model, SimpleBrush(2), minSize, simplifier, transparentHandler);
        }

        {
            ...
            opaqueLayer.apply(SDF::opUnion, &function, model, SimpleBrush(7), minSize, simplifier, opaqueHandler);
        }
    ...
    
        {
            ...
            opaqueLayer.apply(SDF::opUnion, &function, model, SimpleBrush(11), minSize, simplifier, opaqueHandler);
        }
...

        {
            ...
            Transformation model = Transformation(box.getLength()*0.5f, box.getCenter(), 0, 0, 0);
            BoxDistanceFunction function = BoxDistanceFunction(model, minSize);
            opaqueLayer.apply(SDF::opUnion, &function, model, SimpleBrush(6), minSize*0.5f, simplifier, opaqueHandler);
        }
...

        {
            ...
            opaqueLayer.apply(SDF::opUnion, &distortedFunction, model, SimpleBrush(15), minSize*0.25f, simplifier, opaqueHandler);
        }
    
        {
            ...
            opaqueLayer.apply(SDF::opUnion, &carvedFunction, model, SimpleBrush(15), minSize*0.25f, simplifier, opaqueHandler);
        }
    ...
    
        {
            ...
            opaqueLayer.apply(SDF::opUnion, &distortFunction, model, SimpleBrush(15), minSize*0.25f, simplifier, opaqueHandler);
        }
    ...
    
        {
            ...
            transparentLayer.apply(SDF::opUnion, &function, model, SimpleBrush(0), minSize, simplifier, transparentHandler);
        }
    
        {
            ...
            Transformation model = Transformation(box.getLength()*0.5f, box.getCenter(), 0, 0, 0);
            BoxDistanceFunction function = BoxDistanceFunction(model, minSize);
            opaqueLayer.apply(SDF::opUnion, &function, model, SimpleBrush(0), minSize*4, simplifier, opaqueHandler);
        }
        
        {
            ...
            Transformation model = Transformation(box.getLength()*0.5f, box.getCenter(), 0, 0, 0);
            BoxDistanceFunction function = BoxDistanceFunction(model, minSize);
            opaqueLayer.apply(SDF::opUnion, &function, model, SimpleBrush(0), minSize*0.25, simplifier, opaqueHandler);
        }
        
        {
            ...
            Transformation model = Transformation(box.getLength()*0.5f, box.getCenter(), 0, 0, 0);
            BoxDistanceFunction function = BoxDistanceFunction(model, minSize);
            opaqueLayer.apply(SDF::opPaint, &function, model, SimpleBrush(1), minSize*4.0, simplifier, opaqueHandler);
        }
        
        {
            ...
            Transformation model = Transformation(box.getLength()*0.5f, box.getCenter(), 0, 0, 0);
            BoxDistanceFunction function = BoxDistanceFunction(model, minSize);
            opaqueLayer.apply(SDF::opPaint, &function, model, SimpleBrush(1), minSize*0.25, simplifier, opaqueHandler);
        }

        {
            ...
            for (int i = 0; i < numSegs; ++i) {
                ...
                opaqueLayer.apply(SDF::opUnion, &roadFunc, roadModel,
                                  SimpleBrush(12),
...

        {
            ...
            for (int ringIdx = 0; ringIdx < 1; ++ringIdx) {
                ...
                for (int i = 0; i < numSegs; ++i) {
                    ...
                    opaqueLayer.apply(SDF::opUnion, &tsFunc, tsModel,
                                      SimpleBrush(14),
                                      minSize, simplifier, opaqueHandler);
                }
            }
