...
layout(binding = 0) uniform UBO {
    ...
    vec4 debugParams; // x=debugMode (0=normal,1=geometry normal,2=normal map,3=uv,4=tangent,5=bitangent,6=raw albedo,7=raw normal map,8=bump/height,9=TBN composite,10=parallax pre-proj,11=normal from derivatives)
} ubo;