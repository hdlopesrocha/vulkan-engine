...
\subsection{Water Geometry Disable}
\begin{itemize}
    \item \texttt{VULKAN\_DISABLE\_WATERGEOM=1} environment variable completely disables water geometry rendering (WaterRenderer::init, line 52).
    \item Used for debugging/profiling water pass overhead.
\end{itemize}
